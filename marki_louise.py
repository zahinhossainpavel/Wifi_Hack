...
print('''
\033[1;92m Recoded By zahinhossainpavel
Telegram:https://t.me/Zahin_Hossain_Pavel
One line Command:\nsudo python Wifi_Hack/marki_louise.py -i wlan0 -K\n
For Help Type:\npython Wifi_Hack/marki_louise.py --help\033[0m
''')
...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.MARKI/sessions/'
        self.pixiewps_dir = f'{user_home}/.MARKI/pixiewps/'
...
def usage():
    return """
OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Zahin Hossain Pavel
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, modded by Zahin Hossain Pavel',
